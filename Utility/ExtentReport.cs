...
namespace GoogleMapTest.Utility
{
    public class ExtentReport
    {
        ...
        public static void ExtentReportInit()
        {
            ...
            htmlReporter.Config.ReportName = "Google Map UI Automation Status Report";
            htmlReporter.Config.DocumentTitle = "Google Map UI Automation Status Report";
            htmlReporter.Config.Theme = Theme.Standard;
            htmlReporter.Start();

            _extentReports = new ExtentReports();
            _extentReports.AttachReporter(htmlReporter);
            _extentReports.AddSystemInfo("Application", "GoogleMaps");
